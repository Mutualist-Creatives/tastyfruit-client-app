          ...
          <div className="mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center w-full gap-8 md:gap-4">
              ...
              <div className="flex flex-col items-start gap-2 w-full md:w-auto">
                ...
                <div className="flex flex-row items-center gap-4 sm:gap-9 mb-3">
                  ...
                  <div className="font-bricolage-grotesque-condensed text-white font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-[88px] bg-[#003BE2] px-2 sm:px-4 py-2 mb-3 -rotate-3 -mt-0">
                    FRESHNESS
                  </div>
                </div>
                <div className="font-bricolage-grotesque-condensed text-[#003CE9] font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-[56px] bg-[#B5FE28] px-2 md:px-4 py-0.5 md:py-2 -mt-6 text-left">
                  THROUGH MINDFUL PLANTATION
                </div>
              </div>

              {/* Blok Kanan: Gambar Hati (HANYA MUNCUL DI MOBILE) */}
              <div className="hidden md:block w-full md:w-auto flex justify-center md:justify-end md:hidden">
                <Image
            ...
            <div className="flex flex-col md:flex-row justify-between items-center w-full gap-6 md:gap-8 mt-2 md:mt-8">
              <div className="w-full md:w-[55%]">
                <div className="font-nunito text-[#003CE9] font-normal text-base sm:text-lg mt-5">
